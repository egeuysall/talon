...
**Project Description**
Talon is a digital engineering teammate that watches real work surfaces like GitHub, Slack, health checks, and deployment signals. Instead of waiting for a prompt, it clocks in on a schedule, collects signals, remembers recent work, understands company context, decides what needs attention, and takes safe actions.
...
Show task queue/signals/reasoning.
